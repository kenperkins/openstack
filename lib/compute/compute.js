...
var Compute = function(client, options) {
    var self = this;

    options = options || {};
    options.serviceName = options.serviceName;
    options.type = services.types.compute;
...
Compute.prototype = {
        ...
        self.authorizedRequest(requestOptions,
            function(err, res, body) {
                ...
                for (var i = 0; i < body.servers.length; i++) {
                    servers.push(new Server(self, body.servers[i]));
                }
    ...
    getServer: function(id, callback) {
        ...
        self.authorizedRequest(requestOptions,
            ...
            callback(err, new Server(self, body.server));
        });
    },

    /**
     * @name Compute.createServer
     *
     * @description Creates a server with the specified options. The flavor / image
     * properties of the options can be instances of server objects
     * (Flavor, Image) OR ids to those entities in Openstack.
     *
    ...
    createServer: function(options, callback) {
        ...
        flavorId = options['flavor'] instanceof Flavor ?
            options['flavor'].id : parseInt(options['flavor'], 10);

        imageId = options['image'] instanceof Image ?
        ...
        self.authorizedRequest(requestOptions,
            ...
            callback(err, new Server(self, _.extend({}, body.server, options)));
        });
    },

    /**
     * @name Compute.createServerWithWait
     *
    ...
    getFlavors: function(details, callback) {
        ...
        self.authorizedRequest(requestOptions,
            ...
            for (var i = 0; i < body.flavors.length; i++) {
                flavors.push(new Flavor(self, body.flavors[i]));
            }
    ...
    getFlavor: function(id, callback) {
        ...
        self.authorizedRequest(requestOptions,
            ...
            callback(err, new Flavor(self, body.flavor));
        });
    },

    /**
     * @name Compute.getImages
     *
    ...
    getImages: function(details, callback) {
        ...
        self.authorizedRequest(requestOptions,
            ...
            for (var i = 0; i < body.images.length; i++) {
                images.push(new Image(self, body.images[i]));
            }
    ...
    getImage: function(id, callback) {
        ...
        self.authorizedRequest(requestOptions, function(err, res, body) {
            ...
            callback(err, new Image(self.client, body.image));
        });
    },

    /**
     * @name Compute.createServerImage
     *
    ...
    createServerImage: function(options, callback) {
        ...
        var serverId = options.server instanceof Server ?
        ...
        self.authorizedRequest(requestOptions,
            ...
            // TODO HACK
            // returns a URL to a non-existant End point, so instead
    ...
    destroyImage: function(image, callback) {
        var self = this,
            imageId = image instanceof Image ? image.id : image;
        ...
        self.authorizedRequest(destroyOptions,
            function(err, res) {
