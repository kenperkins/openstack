var _ = require('underscore'),
    ...
    services = require('./../client/services').services,
    serviceTypes = require('./../client/services').serviceTypes;
...
var Compute = function(client, options) {
    ...
    options.type = serviceTypes.compute;
...
Compute.prototype = {
    ...
    getServers: function(details, callback) {
        ...
        self.client.authorizedRequest(self.service, requestOptions,
    ...
    getImage: function(id, callback) {
        ...
        self.authorizedRequest(requestOptions, function(err, res, body) {
            ...
            callback(err, new Image(self, body.image));
        });
    },
    ...
    destroyImage: function(image, callback) {
        ...
        self.client.authorizedRequest(self.service, destroyOptions,
            function(err, res) {
